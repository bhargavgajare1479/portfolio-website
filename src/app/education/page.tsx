...
export default function EducationPage() {
  return (
    <>
      ...
      <main className="mt-12 w-full flex flex-col items-center bg-background">
        <div className="flex-1 w-full flex flex-col items-center justify-center overflow-auto">
          <h1 className={`text-3xl sm:text-4xl md:text-5xl font-bold uppercase text-center ${lexend.className}`}>Education</h1>
