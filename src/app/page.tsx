          ...
          <TileLink href="/education" className="flex h-full flex-col group cursor-pointer">
            <div className="flex h-full flex-col justify-center">
              <div className="flex items-center gap-3">
                <h2 className="font-heading text-4xl sm:text-5xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100 group-hover:opacity-80 transition-opacity">Education</h2>
          ...
          <TileLink href="/projects" className="flex h-full flex-col group cursor-pointer">
            ...
            <div className="mt-8 space-y-8 flex-1 overflow-y-auto pr-4">
              <div className="flex flex-col">
                ...
                <p className="mt-2 text-lg sm:text-xl font-normal text-zinc-600 dark:text-zinc-300 leading-relaxed">
                  Digital Forensics • Data Recovery • Filesystem Parsing
                </p>
              </div>

              <div className="flex flex-col">
                <h3 className="text-2xl sm:text-3xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100 group-hover:text-black dark:group-hover:text-white transition-colors">
                  AR Application: Homewise Vision
                </h3>
                <p className="mt-2 text-lg sm:text-xl font-normal text-zinc-600 dark:text-zinc-300 leading-relaxed">
                  Spatial Computing • AR Visualization • Furniture Placement
                </p>
              </div>
              ...
              <div className="flex flex-col">
                ...
                <p className="mt-2 text-lg sm:text-xl font-normal text-zinc-600 dark:text-zinc-300 leading-relaxed">
                  Immersive Systems • OpenXR • Hardware Optimization
                </p>
              </div>
            </div>
          </TileLink>
        ...
        <BentoCard id="skills" className="order-5 lg:order-5 lg:col-span-5 min-h-[300px] lg:min-h-[400px]">
          <TileLink href="/skills" className="flex h-full flex-col group cursor-pointer">
            <div className="flex h-full flex-col">
              <div className="flex items-center gap-3">
                <h2 className="font-heading text-4xl sm:text-5xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100 group-hover:opacity-80 transition-opacity">Skills</h2>
                <FaLink className="w-5 h-5 sm:w-6 sm:h-6 text-zinc-900 dark:text-zinc-100 transition-transform duration-300" />
              </div>
