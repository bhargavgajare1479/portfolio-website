                ...
                <div className="flex items-center gap-2">
                  {project.githubUrl && (
                    <a
                      ...
                      className="text-zinc-600 dark:text-zinc-400 hover:text-black dark:hover:text-white bg-zinc-100 dark:bg-zinc-800 p-2 rounded-full hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors"
                    >
                      <FaGithub size={16} />
                    </a>
                  )}
