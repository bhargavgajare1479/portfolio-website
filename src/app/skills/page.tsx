      ...
      <div className="max-w-screen-xl mx-auto px-4 sm:px-8">
        ...
        <div className="mt-6 grid grid-cols-3 gap-x-0 gap-y-4 justify-items-center mx-auto">
          <div className="group flex flex-col items-center">
            <SiC size={36} className="text-white" />
          ...
          <div className="group flex flex-col items-center">
            <SiCplusplus size={36} className="text-white" />
            <span className="mt-2 text-xs opacity-0 group-hover:opacity-100 transition-opacity bg-background px-2 py-1 rounded shadow text-foreground ${lexend.className}">C++</span>
          </div>
          <div className="group flex flex-col items-center">
            <img src="/csharp.svg" alt="C#" width={36} height={36} className="object-contain" />
            <span className="mt-2 text-xs opacity-0 group-hover:opacity-100 transition-opacity bg-background px-2 py-1 rounded shadow text-foreground ${lexend.className}">C#</span>
          </div>
          <div className="group flex flex-col items-center">
            <img src="/java.svg" alt="Java" width={36} height={36} className="object-contain" />
          ...
          <div className="group flex flex-col items-center">
            <SiPython size={36} className="text-white" />
          ...
          <div className="group flex flex-col items-center">
            <SiHtml5 size={36} className="text-white" />
          ...
          <div className="group flex flex-col items-center">
            <SiCss3 size={36} className="text-white" />
          ...
          <div className="group flex flex-col items-center">
            <SiJavascript size={36} className="text-white" />
          ...
          <div className="group flex flex-col items-center">
            <SiTypescript size={36} className="text-white" />
        ...
        <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-x-0 gap-y-4 justify-items-center mx-auto">
          <div className="group flex flex-col items-center">
            <img src="/unity.svg" alt="Unity" width={36} height={36} className="object-contain" />
          ...
          <div className="group flex flex-col items-center">
            <SiReact size={36} className="text-white" />
          ...
          <div className="group flex flex-col items-center">
            <img src="/next.svg" alt="Next.js" width={36} height={36} className="object-contain" />
          ...
          <div className="group flex flex-col items-center">
            <img src="/tailwind.svg" alt="Tailwind CSS" width={36} height={36} className="object-contain" />
        ...
        <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-x-0 gap-y-4 justify-items-center mx-auto">
          <div className="group flex flex-col items-center">
            <SiFirebase size={36} className="text-white" />
          ...
          <div className="group flex flex-col items-center">
            <SiGit size={36} className="text-white" />
          ...
          <div className="group flex flex-col items-center">
            <SiMysql size={36} className="text-white" />
          ...
          <div className="group flex flex-col items-center">
            <img src="/vercel.svg" alt="Vercel" width={36} height={36} className="object-contain" />
          ...
          <div className="group flex flex-col items-center">
            <SiGooglecloud size={36} className="text-white" />
