...
export const projects: Project[] = [
  {
    ...
    challenges: [
      "Engineered low-level filesystem parsers capable of reconstructing deleted inodes and metadata across Btrfs, NTFS, and XFS storage layouts.",
      "Overcame Copy-On-Write (CoW) metadata volatility by implementing fast heuristic block-level carving for file recovery.",
      "Integrated AI-based content analysis tools to automatically classify recovered media and detect forensic artifacts within large disk images.",
      "Optimized multi-threaded disk image scanning to handle complex storage layouts and fragmented data structures efficiently.",
    ],
  },
  {
    slug: "homewise-vision",
    title: "AR Application: Homewise Vision",
    keywords: ["Spatial Computing", "AR Visualization", "Furniture Placement"],
